...
class List
{
  ...
  public:
      ...
      class const_reverse_iterator 
    {
       public:
        ...
        {
            //change to prev since we start from tail
            current = current->prev;
            return *this;
        }
  ...
  public:
    ...
    // function to create a loop within the list
    // getNode() is a function that returns iterator's current node line 80
    void createLoop(iterator itr) {
      tail->prev->next = itr.getNode();
